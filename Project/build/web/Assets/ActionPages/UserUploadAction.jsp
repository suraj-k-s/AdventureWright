...
//checking if request cotains multipart data
            ...
            if (isMultipart) {
                ...
                while (itr.hasNext())//checking if there is any value in the position like rs.next()
                {
                    ...
                    String ins = "insert into tbl_user (user_place_id,user_first_name,user_last_name,user_gender,user_dob,user_contact,user_email,user_address,user_password,user_photo,user_proof)"
                            + "values('"+value[1]+"','"+value[2]+"','"+value[3]+"','"+value[4]+"','"+value[5]+"','"+value[6]+"','"+value[7]+"','"+value[8]+"','"+value[9]+"','"+fn+"','"+pn+"')";
