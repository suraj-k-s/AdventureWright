...
//checking if request cotains multipart data
            ...
            if (isMultipart) {
                ...
                while (itr.hasNext())//checking if there is any value in the position like rs.next()
                {
                    ...
                    } else//when it is an image or multipart
                    {
                        ...
                        if (field_name.equals("img_image"))//write the name of image here it is img_product
                        {
                    ...
                    String ins = "insert into tbl_location_gallery(location_id,location_gallery_caption,location_gallery_image)values('"+value[1]+"','"+value[2]+"','"+fn+"')";
        ...
        <script type="text/javascript">
            setTimeout(function() {
                window.location.href = '../../Admin/LocationGallery.jsp'
