                                        ...
                                        <div class="white_box mb_30">
                                            ...
                                            <form method="post">
                                                <div class="form-group">
                                                    ...
                                                    <input required="" type="text" class="form-control" id="txt_district" name="txt_district" autocomplete="off" />
                                                </div>
                                    ...
                                    <table class="table lms_table_active">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td align="center">
                                                    <a href="District.jsp?id=<%=rs.getString("district_id")%>" class="status_btn">Delete</a> 
                                                </td> 
                                            </tr>
                                            <%
                                                }
