...
<%
    if (request.getParameter("btn_pay") != null) {
        String a = "update tbl_packagebooking set booking_status='1' where booking_id='" + request.getParameter("bid") + "'";
        if (con.executeCommand(a)) {
%>
            <script>
                alert("confirmed by Travel Get");
...
<head>
	...
	<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.css" integrity="sha512-5A8nwdMOWrSz20fDsjczgUidUBR8liPYU+WymTZP1lmY9G6Oc7HlZv156XqnsgNUzTyMefFTcsFH/tnJE/+xBg==" crossorigin="anonymous" referrerpolicy="no-referrer" />	<title>PSST - Payement Gateway</title>
</head>
<body>
	<div class="wrapper">
		...
		<form method="POST">
			...
			<div class="input-group">
				<div class="input-box">
					<input class="name" type="email" readonly value="<?php echo $_GET["rate"] ?>" name="txtemail" id="txtemail" placeholder="Email Address" required>
