...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark " id="ftco-navbar" style="margin-bottom:120px">
        <div class="container">
            <a class="navbar-brand" href="../Index.jsp">Travel<span style="font-size:21px">Get</span></a>
            ...
            <div class="collapse navbar-collapse" id="ftco-nav">
                ...
                <li class="nav-item active"><a href="../index.jsp" class="nav-link">Home</a></li>
                    <li class="nav-item"><a href="Myprofile.jsp" class="nav-link">My Profile</a></li>
                    ...
                    <li class="nav-item"><a href="ViewUserBookings.jsp" class="nav-link">View User Bookings</a></li>
