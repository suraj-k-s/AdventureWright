...
//checking if request cotains multipart data
            ...
            if (isMultipart) {
                ...
                while (itr.hasNext())//checking if there is any value in the position like rs.next()
                {
                    ...
                    String ins = "`tbl_package` ( `package_type_id`, `district_id`,`package_name`, `package_rate`, `package_details`, `package_photo`)"
                            + "values('"+value[0]+"','"+value[1]+"','"+value[2]+"','"+value[3]+"','"+value[4]+"','"+fn+"')";
        ...
        <script type="text/javascript">
            setTimeout(function() {
                window.location.href = '../../Admin/Package.jsp'
