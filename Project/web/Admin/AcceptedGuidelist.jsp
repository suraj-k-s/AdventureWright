...
<%
    ...
    if (request.getParameter("rejid") != null) {
        ...
        String upQry = "update tbl_guide set guide_status='2' where guide_id='" + request.getParameter("rejid") + "'";
...
%>
    <body>
                    <table width="200" border="1" style="margin-left: 280px;" >
                        ...
                        <%                            String selqry = "select * from tbl_guide g inner join tbl_place p on g.place_id=p.place_id inner join tbl_district d on p.district_id=d.district_id where g.guide_status='1'";
                        ...
                        <tr>
                            ...
                            <td><a href="AcceptedGuidelist.jsp?rejid=<%=rs.getString("guide_id")%>">Reject</a></td>
                        </tr>
                        <%
                        }
                        %>
